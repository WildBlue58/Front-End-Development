<!-- ============================================================
     ModelControlPanel.vue —Practice2 的控制面来
     
     深色毛玻璃风格，一Practice1 一自
     功能区域：
     →模型选择（切换两个GLB模型：
     →动画控制（播放暂停/切换/速度调节：
     →相机视角预设（正面侧面/顶部/45度）
...
const modelDescriptions: Record<string, string> = {
    "保时换911": "2014款保时捷911 Turbo (991)，经典跑转D模型",
    初音未来: "初音未来 LBX 改版，带骨骼动画的角色模型,
};

const currentDescription = computed(() => {
    return (
        modelDescriptions[currentModel.value.name] ||
        currentModel.value.description
    );
});
</script>
    ...
    <div class="control-panel">
        ...
        <div class="panel-section">
            ...
            <div v-if="availableAnimations.length > 1" class="anim-tracks">
                <div class="label" style="margin-bottom: 6px">动画轨道</div>
            ...
            <div class="speed-control">
                <div class="speed-header">
                    ...
                    <span class="speed-value"
                        >{{ animationSpeed.toFixed(1) }}x</span
                    >
                </div>
                <input
                    type="range"
        ...
        <div class="panel-section">
            ...
            <div class="info-list">
                ...
                <div class="info-row">
                    ...
                    <span
                        class="info-value"
                        :class="isModelLoaded ? 'loaded' : 'loading'"
                    >
                        {{
                            isModelLoaded
                                ? "✨已加转
