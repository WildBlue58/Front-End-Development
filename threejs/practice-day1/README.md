# Three.js 练习项目 — Day 1 & Day 2

> Vue 3 + TresJS 3D 学习项目，包含基础几何体场景（Day 1）和 GLB 模型加载与动画控制（Day 2）。
...
| 路由           | 内容                                        |
| -------------- | ------------------------------------------- |
| `/#/practice1` | Day 1：基础几何体 + 材质 + 光照 + 轨道控制  |
| `/#/practice2` | Day 2：GLB 模型加载、动画控制、相机视角切换 |

## 主要依赖

- Three.js 0.183 + TresJS Core 5 + TresJS Cientos 5
- Vue 3.5 + TypeScript 6 + Vue Router 4
